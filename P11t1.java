public class P11t1
{
  ...
  public static void main(String[] argv)
  {
    ...
    {
      {8,2,22,99,38,15,00,40,00,75,4,5,7,78,52,12,50,77,91,8},
      {49,49,99,40,17,81,18,57,60,87,17,40,98,43,69,48,4,56,62,00},
      {81,99,31,73,55,79,14,29,93,71,40,67,53,88,30,3,49,13,36,65},
      {99,70,95,23,4,60,11,42,69,24,68,56,1,32,56,71,37,2,36,91},
...
//            if (nonce1 > aMaxTotal)
//            { aMaxTotal=nonce1;
//              System.out.println("nonce1=" + nonce1); }//end-if-then-construct
